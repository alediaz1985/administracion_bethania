...
urlpatterns = [
    ...
    path('consultar/', views.consultar_estudiante, name='consultar_estudiante'),
    ...
    path('generar_pdf_lista_estudiantes/', views.generar_pdf_lista_estudiantes_view, name='generar_pdf_lista_estudiante'),
